...
<%--        <source src="https://giphy.com/embed/3qh8KiGj3QZtPoVQ60" type="gif">--%>
<%--&lt;%&ndash;        <source src="https://c.tenor.com/B1pr6_svEpcAAAPo/bee-club-bee-club-gc.mp4" type="video/mp4">&ndash;%&gt;--%>
<%--&lt;%&ndash;        <iframe src="https://giphy.com/embed/3qh8KiGj3QZtPoVQ60" width="480" height="340" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/Pimpyopets-pimpyopets-pimp123-pyp123-3qh8KiGj3QZtPoVQ60">via GIPHY</a></p>&ndash;%&gt;--%>
<%--    </video>--%>
<%--</div><br>--%>
...
<%--                                          fill="white" />--%>
<%--                                </g>--%>
<%--                                <path id="Vector_16" opacity="0.25" d="M376.1 240.6C376.1 240.6 378.7 238.3 380.6 235.8C381.4 238.2 383.1 240 384.1 240.9C382.3 242.2 380.5 242.8 378.6 242.7C372.3 242.5 376.1 240.6 376.1 240.6Z"--%>
<%--                                      fill="black" />--%>
<%--                            </g>--%>
<%--                            <path id="Vector_17"--%>
...
<%--                        </g>--%>
<%--                        <g id="Group_7">--%>
<%--                            <path id="Vector_24" d="M237.3 191.1V97.5H201.8V97.8L159 166.6L140.3 196.7L142.4 218.4H201.8V251H237.3V218.4H253V191H237.3V191.1ZM201.8 191.1H174.2L199.6 147.4L201.8 143.8V191.1Z"--%>
...
<%--                            <path id="Vector_30" d="M291.5 110.1C291.5 110.1 279.6 101.5 278.3 88.1C286.9 90.5 291.5 101 291.5 101C291.5 101 289.3 91.4 291.5 84.9C297.8 94.1 296.1 101.6 291.5 110.1Z"--%>
...
<%--                                      fill="#2F1829" />--%>
<%--                                <path id="Vector_57" opacity="0.25" d="M562 232.1L559.3 216.4C559.3 216.4 560 210.1 560.3 209.3C560.6 208.6 562.5 209.1 563.3 208.6C563.7 209.6 561 211 560.8 214.3C560.7 216.6 561.5 226.7 562 232.1Z"--%>
<%--                                      fill="black" />--%>
...
<%--                                      stroke="white" stroke-width="0.4635" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />--%>
...
<%--                                      fill="black" />--%>
<%--                                <path id="Vector_71" opacity="0.25" d="M569.5 199.1C569.4 199.2 569.2 199.3 569 199.4C567.5 200.1 563.7 200.1 559.8 199.9C562.4 199.6 568.7 198.2 569.8 192.7C570.1 195.2 570.3 198.2 569.5 199.1Z"--%>
<%--                                      fill="black" />--%>
...
<%--                                              d="M105.9 185.3L106 185.7L106.1 185.9H83.3C83.3 185.7 83.3 185.6 83.3 185.4H105.9V185.3ZM106 185.1H83C83 185.4 83 185.7 83 186.1H106.4C106.3 185.8 106.1 185.4 106 185.1Z" fill="white" />--%>
<%--                                    </g>--%>
...
<%--                                <path id="Vector_121" opacity="0.25" d="M114.4 194.6C114.6 193.6 114.7 191.8 114.6 191.2C114.8 191.1 115 191 115.2 190.9C115.8 191.8 116.9 193.5 117 195.5C116.3 195.2 115.7 194.6 114.4 194.6Z"--%>
<%--                                      fill="black" />--%>
...
<%--                                      d="M224.4 236.4H222.2L223.6 237.9L222.9 244.7L221.7 245.3L218.9 237.7C219 236.8 219.2 235.7 219.4 234.3C220.5 234.7 222.4 235 224.5 233.8C224.4 235.5 224.4 236.4 224.4 236.4Z" fill="black" />--%>
<%--                            </g>--%>
<%--                            <path id="Vector_146"--%>
